...
public class CppVisitor extends ArduinoVisitor implements ArduinoAstVisitor<Void> {
    ...
    public Void visitTemperatureSensor(TemperatureSensor<Void> temperatureSensor) {
        this.sb.append("analogRead(_TMP36_" + temperatureSensor.getPort().getOraName() + ")");
        return null;
    }
    ...
    public Void visitVoltageSensor(VoltageSensor<Void> potentiometer) {
        this.sb.append("analogRead(_output_" + potentiometer.getPort().getOraName() + ")*_sensingToVolts");
        return null;
    }
